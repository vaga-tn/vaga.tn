            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-base font-bold text-zinc-900">ON-PREMISE (MINI-PC)</h3>
                </div>
                <p className="text-sm text-zinc-600 pl-13 ml-13 border-l-2 border-transparent">
                  Installation locale sur serveur dédié ou Mini-PC. Indépendance totale vis-à-vis d'Internet et contrôle physique absolu.
                </p>
              </div>
